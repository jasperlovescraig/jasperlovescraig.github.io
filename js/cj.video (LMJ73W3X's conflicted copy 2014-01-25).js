		...
		Videoset : {
			...
			Tab : {
				...
				setup : function () {
                    ...
                    this.initialConfig = $('#theVideos a[data-initial-video="true"]').data();
				...
				html : function (videoData) {
                    ...
                    if (videoData.videoSrc.length > 0 ) {
                        ...
                        html += '<iframe src="' + videoData.videoSrc + '" width="' + videoData.videoWidth + '" height="'+ videoData.videoHeight + 'webkitallowfullscreen="true" mozallowfullscreen="true" scrolling="no" frameborder="0" style="border: none; overflow: hidden;" />';
